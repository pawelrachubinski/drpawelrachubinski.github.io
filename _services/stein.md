...
Bei Verdacht auf Harnleiter- oder Nierensteine erfolgt zunächst eine strukturierte urologische Abklärung. Wichtige diagnostische Bausteine sind:
...
Auf Basis von Steingröße, Lage, Dichte und anatomischen Gegebenheiten wird das optimale Therapieverfahren individuell festgelegt. Aktuelle Leitlinien empfehlen dabei minimalinvasive endoskopische Verfahren als Standard.
...
Beide Eingriffe erfolgen in der Regel in Vollnarkose.

<strong>Vorteile</strong>

minimalinvasive Verfahren ohne große Schnitte
hohe Steinfreiheitsraten
schonende Behandlung auch komplexer Steinsituationen
kurze Krankenhausaufenthalte
schnelle Erholung und rasche Rückkehr in den Alltag
präzise Steinzertrümmerung durch moderne Lasertechnologie

<strong>Wann ist die Behandlung sinnvoll?</strong>

Eine operative Steintherapie wird empfohlen bei:

anhaltenden Schmerzen oder Koliken
Harnstau der Niere
...
individuell angepasstes Verfahren je nach Steintyp
hohe Planungssicherheit durch präzise Bildgebung
Kombination verschiedener Techniken bei komplexen Steinen möglich
Grundlage für gezielte Nachsorge und Steinprophylaxe

<strong>Risiken</strong>

Wie bei jedem operativen Eingriff können Komplikationen auftreten, sind jedoch selten. Möglich sind vorübergehende Blutungen, Schmerzen beim Wasserlassen oder Infektionen. Bei der mini-PCNL kann es in seltenen Fällen zu stärkeren Blutungen kommen. Insgesamt gelten beide Verfahren als sehr sicher und gut etabliert.

Alle Risiken sowie Vor- und Nachteile der jeweiligen Methode bespreche ich gerne ausführlich im persönlichen Aufklärungsgespräch.
